...
#modelCheckPoint
modelCheckpoint = ModelCheckpoint(filepath = 'vgg19_melanoma_' +str(input_size) +'x' + str(input_size) + '.h5',
                                  monitor='val_loss',
                                  verbose=1,
                                  save_best_only=True,
...
#load model
model=load_model('vgg19_melanoma_' +str(input_size) +'x' + str(input_size) + '.h5')
